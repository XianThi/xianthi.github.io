...
echo building...
echo Packages MD5SUM: $(md5sum ./Packages | sed "s/\MD5 (.\/Packages) = //g")
PackagesMD5Sum=$(md5sum ./Packages | sed "s/\MD5 (.\/Packages) = //g")
...
echo Packages.bz2 MD5SUM: $(md5sum ./Packages.bz2 | sed "s/\MD5 (.\/Packages.bz2) = //g")
PackagesBZ2MD5Sum=$(md5sum ./Packages.bz2 | sed "s/\MD5 (.\/Packages.bz2) = //g")
...
echo Packages.xz MD5SUM: $(md5sum ./Packages.xz | sed "s/\MD5 (.\/Packages.xz) = //g")
PackagesXZMD5Sum=$(md5sum ./Packages.xz | sed "s/\MD5 (.\/Packages.xz) = //g")
...
echo Packages.zst MD5SUM: $(md5sum ./Packages.zst | sed "s/\MD5 (.\/Packages.zst) = //g")
PackagesZSTMD5Sum=$(md5sum ./Packages.zst | sed "s/\MD5 (.\/Packages.zst) = //g")
